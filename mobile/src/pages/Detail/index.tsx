...
import { View,Text ,TouchableOpacity,StyleSheet,Image, SafeAreaView , Linking} from 'react-native';
...
const Detail = () => {
    ...
    function handleMailCompose(){
      MailComposer.composeAsync({
        subject:'Interesse na colet de resíduos',
        recipients: [data.email]
      })
    }

    function handleWhatsapp(){
      Linking.openURL(`whatsapp://send?chatId=Dtv0aGvdXvHGWpGW46aXAM&text=Tenho interesse sobre coleta de resíduos`)
    }
