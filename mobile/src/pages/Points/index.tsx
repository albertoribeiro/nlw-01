...
const Points = () => {
  ...
  useEffect(()=>{
    console.log(routeParams,selectedItems)
    api.get('points',{
      params:{
  ...
  function handleSelectItem(id:number){
    const alredSelected:number = selectedItems.findIndex(item => item === id);
    if(alredSelected>=0){
        const filteredItems:number[] = selectedItems.filter(item =>item !== id);
        setSelectedItems(filteredItems);
    }else{
        const selectedItemsAux:number[] = [...selectedItems, id];
